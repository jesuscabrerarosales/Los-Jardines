...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="container-fluid facts py-5 pt-lg-0">
        <div class="container ">
            <div class="row gx-0">
                <div>
                    <h1 class="reason">
                        Números de utilidad para el vecino
                    </h1>
                    <style>
                        .reason {
                            color: #000000;
    ...
    <div class="banner" style="background-color: #495057;padding:40px">
        <div class="container ">
            <h1 style="color: white;">Áreas tematicas de la Urbanización Los Jardines</h1>
        </div>
    </div>
