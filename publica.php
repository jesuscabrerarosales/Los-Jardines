    ...
    <div class="row">
        <div class="col">
            <div class="banner text-center">
                <h1 class="display-4" style="font-size: 80px;">¡Publica tu negocio!</h1>
                <p class="lead" style="font-size: 40px;">¿Tienes un negocio local? ¡Hazlo conocer a la comunidad!</p>
                <a href="contactanos.php" class="btn" style="border: 1px solid #000000;padding: 20px;">Contacta con nosotros</a>
            </div>
        </div>
        <div class="col">
